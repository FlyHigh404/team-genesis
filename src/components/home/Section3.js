...
const serviceList = [
  {
    ...
    description2: "Jangan biarkan masalah kecil menjadi besar! Perbaiki kendaraan listrik Anda di bengkel rekanan kami dengan jaminan layanan terbaik dan harga transparan.",
    bgColor: "bg-white",
  },
  {
    ...
    description2: "Tak perlu khawatir mencari onderdil yang tepat! Belanja spare part original dan berkualitas dengan harga terbaik langsung dari BETULIN.",
  ...
  },
  {
    ...
    description2: "Jangan sampai kehabisan daya di tengah perjalanan! Cek lokasi, kapasitas, dan metode pembayaran dengan sekali klik.",
    bgColor: "bg-white",
  },
  {
    ...
    description2: "Bingung dengan kondisi kendaraanmu? AI kami siap memberi rekomendasi cepat, atau langsung hubungi mekanik berpengalaman untuk solusi lebih spesifik.",
    bgColor: "bg-icon-service-1",
  },
  {
    ...
    description2: "Tak bisa ke bengkel? Kami yang datang! Panggil mekanik terdekat kapan pun untuk perbaikan di lokasi pilihanmu.",
    bgColor: "bg-white",
  },
  {
    ...
    description2: "Mau tahu cara merawat baterai atau memilih spare part terbaik? Temukan konten edukatif yang mudah dipahami, langsung dari BETULIN.",
    bgColor: "bg-icon-service-1",
  },
  {
    ...
    description2: "Kendaraan listrikmu butuh perhatian rutin! Atur pengingat otomatis agar selalu tepat waktu dalam melakukan servis dan perawatan.",
    bgColor: "bg-icon-service-1",
  },
];
...
export default function Section3() {
  return (
    <section className="w-full min-h-dvh py-32 px-8 max-w-7xl sm:px-12 md:px-14 lg:px-16 mx-auto">
      ...
      <p className="bg-gradient-to-r font-medium from-primary-n1 to-foreground-1 text-transparent bg-clip-text mb-2 _text-body-1">Solusi Lengkap di Ujung Jari Anda</p>
        ...
        <p className="text-foreground-2 font-medium max-w-lg mx-auto _text-body-2 leading-snug mt-2">
          Tingkatkan efisiensi dengan solusi terintegrasi untuk perawatan lebih simple dan menjaga performa armada tetap optimal. <br />Fokus pada aktivitas produktif Anda.
        </p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {serviceList.map((service, index) => (
          <ServiceCard
            ...
            className={index === serviceList.length - 1 && serviceList.length % 2 !== 0 ? "md:col-span-2 lg:col-span-1 lg:col-start-2" : ""}
          />
        ))}
      </div>
    </section>
